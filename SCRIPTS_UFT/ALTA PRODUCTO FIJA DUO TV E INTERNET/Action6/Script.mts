...
Sub IngresoDatosLogin()
	...
	JavaWindow("Iniciar sesión").JavaList("Iniciar sesión en:").Select "Ejecutivo de interacción del cliente de Amdocs"
...
Sub EsperaCargaLogin()
	...
	wait 6
	If JavaWindow("Iniciar sesión").JavaDialog("Seleccionar una opción").JavaStaticText("La contraseńa vencerá").Exist = True Then
		JavaWindow("Iniciar sesión").JavaDialog("Seleccionar una opción").JavaButton("No").Click
