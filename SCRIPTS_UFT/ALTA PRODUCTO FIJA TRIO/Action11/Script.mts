...
str_paquete_tv		=   DataTable("e_PaqueteTV", dtLocalSheet)
...
Sub RecursosAltas()
	Select Case DataTable("e_RecursosAltas", dtLocalsheet)
		...
		Wend
		wait 3
		JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_5").JavaEdit("TextFieldNative$1").Set str_paquete_tv '"Bloque Full HD"Bloque Estelar"
		...
		If  JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_5").JavaDialog("Mensaje").JavaStaticText("BLOQUE FULL HD 60 CANALES").Exist = True Then
			...
			JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_5").JavaEdit("TextFieldNative$1").Set "BLOQUE HBO NEW"
			JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_5").JavaButton("Buscar").Click
		While JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_5").JavaCheckBox("Seleccionar").Exist = false
			wait 1
		Wend
...
'		End If
		...
		Call Carga() @@ hightlight id_;_5880905_;_script infofile_;_ZIP::ssf282.xml_;_
		wait 1
			'Guardar numero
			Dim n6
